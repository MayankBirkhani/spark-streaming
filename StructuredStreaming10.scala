...
//Implementation of watermark with Append as output mode.
//Implementation of Sliding window

object StructuredStreaming10 extends App{
  ...
  .groupBy(window(col("order_date"),"15 minute","5 minute")) // windowing col->order_date, window size->15 minute, sliding interval->5 minute. That means there will be 10 min overlapping.                
