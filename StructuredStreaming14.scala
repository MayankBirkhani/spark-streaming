...
// Implemented left outer join.
// Implemented extra condition on Joins to consider only the clicks of certain time frame.


object StructuredStreaming14 {
 ...
 // val joinExpr = impressionsDfNew.col("impressionID") === clickDfNew.col("clickID")
  val joinExpr = expr("impressionID == clickID AND ClickTime BETWEEN ImpressionTime + interval 15 minute")
